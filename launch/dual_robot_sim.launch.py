...
def generate_launch_description():
    ...
    print(f'Set the world (default marsyard2020), e.g. ros2 launch ntu_hmrs_sim dual_robot_sim.launch.py world:=forest')
    ...
    sim_config_path = os.path.join(ntu_hmrs_sim_share_dir, 'config', 'dual_robot_' + world + '_sim.yaml')
    ...
    ros_gz_config = os.path.join(ntu_hmrs_sim_share_dir, 'config', 'dual_robot_rgbd_lidar_ros_gz_bridge.yaml') # Change here for relevant sensor config
