...
def generate_launch_description():
    ...
    sim_config_path = os.path.join(ohms_sim_share_dir, 'config', 'tri_robot_ugv_terrain_forest_sim.yaml')
    ...
    ros_gz_config = os.path.join(ohms_sim_share_dir, 'config', 'tri_robot_ugv_rgbd_lidar_ros_gz_bridge.yaml')
    ...
    print('If you want to control the robots with the keyboard, run the following commands in separate terminals:')
    ...
    print('ros2 run teleop_twist_keyboard teleop_twist_keyboard --ros-args -r __node:=teleop_twist_keyboard_node_ravana -r /cmd_vel:=/ravana/cmd_vel')
